...
(function() {
    ...
    ResizeHandler.prototype.resize = function(event) {
      ...
      if (event.detail.i !== undefined) {
        ...
        this.parameters.pointCoords = [
          array[event.detail.i][0],
          array[event.detail.i][1]
        ];
      }
      ...
      switch (event.type) {
          ...
          this.calc = function(diffX, diffY) {
            ...
            if (
              ...
              this.el
                ...
                .size(
                  this.parameters.box.width - snap[0],
                  this.parameters.box.height - snap[1]
                );
            }
          };
          break;
            ...
            this.el
              ...
              .rotate(
                this.parameters.rotation +
                  angle -
                  (angle % this.options.snapToAngle),
        ...
        case 'point':
          this.calc = function(diffX, diffY) {
            ...
            array[this.parameters.i][0] =
              this.parameters.pointCoords[0] + snap[0];
            array[this.parameters.i][1] =
              this.parameters.pointCoords[1] + snap[1];
    ...
    ResizeHandler.prototype.snapToGrid = function(
      diffX,
      diffY,
      flag,
      pointCoordsY
      ...
      if (typeof pointCoordsY !== 'undefined') {
        ...
        temp = [
          (this.parameters.box.x +
            diffX +
            (flag & 1 ? 0 : this.parameters.box.width)) %
            this.options.snapToGrid,
          (this.parameters.box.y +
            diffY +
            (flag & (1 << 1) ? 0 : this.parameters.box.height)) %
            this.options.snapToGrid
        ];
      }
      ...
      diffX -=
        Math.abs(temp[0]) < this.options.snapToGrid / 2
          ? temp[0]
          : temp[0] -
            (diffX < 0 ? -this.options.snapToGrid : this.options.snapToGrid);
      diffY -=
        Math.abs(temp[1]) < this.options.snapToGrid / 2
          ? temp[1]
          : temp[1] -
            (diffY < 0 ? -this.options.snapToGrid : this.options.snapToGrid);
  
      return this.constraintToBox(diffX, diffY, flag, pointCoordsY);
    };
  
    // keep element within constrained box
    ResizeHandler.prototype.constraintToBox = function(
      diffX,
      diffY,
      flag,
      pointCoordsY
    ...
    SVG.extend(SVG.Element, {
      ...
      resize: function(options) {
        (this.remember('_resizeHandler') || new ResizeHandler(this)).init(
          options || {}
        );
